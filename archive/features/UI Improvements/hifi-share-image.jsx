              ...
              {day.skipped ? (
                ...
                <React.Fragment>
                  ...
                  {day.fruit && F[day.fruit] && (
                    <div style={{ color: SH.color.sub }}><span style={{ color: SH.color.sub, fontWeight: 700, fontSize: 10.5, letterSpacing: '0.1em', textTransform: 'uppercase' }}>Fruit&nbsp;&nbsp;</span>{F[day.fruit].name}</div>
                  )}
                </React.Fragment>
              )}
            </div>
