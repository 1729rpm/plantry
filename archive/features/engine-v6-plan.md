...
| F4     | Content: hummus recategorized as a main, if decided                                                                                                       | `data/dishes/hummus.md`, `data/changelog.md`                                                                                                                                                                                                                                                                           | Rajat's decision (PR to `main`)             | PR #259 open (Rajat, 2026-09-07: hummus is a lunch main) |
