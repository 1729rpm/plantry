...
| ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| A      | Engine §4 favorites step + Convex (§3 + §4 of this spec); engine.md §4/§12; feature activation (spec commit, PLAN.md Phase 6 row, CLAUDE.md line append) | engine/src/priority.ts, engine/src/generateWeek.ts, engine/test/priority*, engine/test/simulation*, docs/engine.md §4/§12, app/convex/schema.ts, app/convex/favorites.ts, app/convex/queries/{favorites,nextWeekQueue}.ts, app/convex/nextWeekQueueMutations.ts, app/convex/generateWeek.ts, features/wishlist.md, docs/PLAN.md, CLAUDE.md | engine-v3 Stream A MERGED (see §7)                                                                                                      | blocked on engine-v3 |
| B      | Wishlist sub-view UI (§5 of this spec)                                                                                                                   | app/web/src/App.tsx, app/web/src/components/ExploreScreen.tsx (header wiring only), new app/web/src/components/WishlistScreen.tsx, new FavoriteAddSheet.tsx, app/web/src/index.css                                                                                                                                                         | A merged AND the Deploy Convex action verified green (the frontend reads A's queries; deploying B first blanks the page during the gap) | blocked on A         |
