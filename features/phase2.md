...
| B Engine | in progress | TBD | Slices 1 (eligibility), 2 (schedule), 3 (composition per §3 with §3.1 and §3.2) shipped. Next: priority (§4), then cap (§5), consolidation (§6), `generateWeek`, `rankCandidatesForSlot`, simulation harness. |
