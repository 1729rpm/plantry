...
- The grocery list, grouped (Proteins and Dairy, Fruit, Vegetables, Aromatics and Herbs, Pantry last, no catch-all), day-selected with a time-aware default, and skip-aware, plus the share image family (menu, grocery, recipe sheets) over the native share sheet.
