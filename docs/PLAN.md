...
| 8     | Engine v4.1                           | Generated weeks pass the verification gate in `features/engine-v4.md` §10.8, as amended by §11.4 and §13: a 25-week self-feeding simulation plus three independent evaluations, with every ranking failure cleared                                                                       | abandoned (gate failed twice; superseded by Phase 9, spec archived) |
| 9     | Engine v6                             | Production generates each week with the record-matching engine in `archive/features/engine-v6.md`, and the §11 gate harness in the repo passes on the integrated branch (three 60-week self-feeding runs, weeks 20 to 60) before the merge; plan in `archive/features/engine-v6-plan.md` | shipped                                                             |
