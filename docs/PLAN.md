...
| 9     | Engine v6                             | Production generates each week with the record-matching engine in `features/engine-v6.md`, and the §11 gate harness in the repo passes on the integrated branch (three 60-week self-feeding runs, weeks 20 to 60) before the merge; plan in `features/engine-v6-plan.md` | building                                                            |
